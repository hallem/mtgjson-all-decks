...
namespace AllDecks.Objects
{
    ...
    public class CardDeck : CardDeckSlim
    {
        ...
        public List<string> ColorIndicator { get; set; } // CSV
        ...
        public List<ForeignData> ForeignData { get; set; } // table
        ...
        public Identifiers Identifiers { get; set; } // table
        ...
        //public bool IsSideBoard { get; set; } // Added for Card Deck
        ...
        public Legalities Legalities { get; set; } // table
